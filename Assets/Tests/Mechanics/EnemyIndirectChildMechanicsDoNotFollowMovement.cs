...
namespace Pantheon.Test.Mechanics {
  public static class EnemyIndirectChildMechanicsDoNotFollowMovement {
    public static MechanicData GetMechanicData() {
      ...
      mechanicData.referenceMechanicProperties[Common.BossMechanic] = new MechanicProperties() {
        ...
        mechanic =
            new SpawnMechanicEvent() {
              isPositionRelative = true,
              referenceMechanicName = "boss_mech_child",
            },
      };

      mechanicData.referenceMechanicProperties["boss_mech_child"] = new MechanicProperties() {
        visible = false,
        mechanic =
            new ExecuteMultipleEvents() {
              events = events,
