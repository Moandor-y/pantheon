...
namespace Pantheon.Mechanics
{
    public static class AlmightyJudgement {
        public static MechanicData GetMechanicData() {
            ...
            mechanicData.referenceMechanicProperties["AlmightyJudgementSingleVisual"] = new MechanicProperties() {
                collisionShape = CollisionShape.Round,
            ...
            mechanicData.referenceMechanicProperties["AlmightyJudgementSingleDamage"] = new MechanicProperties() {
                collisionShape = CollisionShape.Round,
                collisionShapeParams = new Vector4(2.1213203435596425732025330863145f, 360, 0, 0),
                colorHtml = "#ff9600",
                mechanic = new ExecuteMultipleEvents() {
            ...
            mechanicData.referenceMechanicProperties["AlmightyJudgementSingle"] = new MechanicProperties() {
                visible = false,
                mechanic = new ExecuteMultipleEvents() {
                    events = new List<MechanicEvent>() {
            ...
            mechanicData.referenceMechanicProperties["AlmightyJudgementYellow"] = new MechanicProperties() {
                visible = false,
                mechanic = new ExecuteMultipleEvents() {
                    events = events,
                },
