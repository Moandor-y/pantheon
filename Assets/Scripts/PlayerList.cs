...
namespace Pantheon {
  public class PlayerList : MonoBehaviour {
    ...
    private List<Tuple<NetworkPlayer, PlayerListItem>> _players =
        new List<Tuple<NetworkPlayer, PlayerListItem>>();
    ...
    private void OnPlayerAdded(NetworkPlayer player) {
      ...
      PlayerListItem item =
          Instantiate(_playerListItemPrefab, transform).GetComponent<PlayerListItem>();
